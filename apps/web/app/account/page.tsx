...
import { ArrowLeft, ArrowRight, Bell, Building2, CalendarClock, Check, Heart, LogOut, MapPin, Package, ShieldCheck, ShoppingBag, Sparkles } from "lucide-react";
...
function AccountHome({ customer, onLogout }: { customer: Customer; onLogout: () => void }) {
  return <main className="account-home"><header className="account-header"><a className="brand" href="/"><span>CAKE</span><span>CITY</span></a><button onClick={onLogout}><LogOut /> Sign out</button></header><section className="account-welcome"><p className="eyebrow">My Cake City</p><h1>Good to have you here,<br /><em>{customer.first_name}.</em></h1><p>Your next celebration starts right here.</p></section><section className="account-grid"><a href="/account/orders"><Package /><span><b>Orders</b><small>Track and reorder your cakes</small></span><ArrowRight /></a><a href="/checkout?recovered=1"><ShoppingBag /><span><b>Saved bag</b><small>Continue your cart on this device</small></span><ArrowRight /></a><a href="/account/subscriptions"><CalendarClock /><span><b>Cake plans</b><small>Scheduled and recurring orders</small></span><ArrowRight /></a><a href="/account/saved"><Heart /><span><b>Saved celebrations</b><small>Favourite cakes and inscription messages</small></span><ArrowRight /></a><a href="/account/notifications"><Bell /><span><b>Updates</b><small>Notifications and channel preferences</small></span><ArrowRight /></a><a href="/account/addresses"><MapPin /><span><b>Delivery addresses</b><small>Save the places you celebrate</small></span><ArrowRight /></a><a href="/account/moments"><Sparkles /><span><b>My moments</b><small>Birthdays and anniversaries</small></span><ArrowRight /></a><a href="/account/rewards"><span className="points">CC</span><span><b>Cake City Rewards</b><small>Points, wallet and membership</small></span><ArrowRight /></a><a href="/corporate"><Building2 /><span><b>Cake City for Business</b><small>Orders, approvals and company invoices</small></span><ArrowRight /></a></section><div className="account-secure"><Check /> Signed in securely as {customer.email}</div></main>;
}
